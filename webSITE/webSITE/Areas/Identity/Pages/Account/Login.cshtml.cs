...
namespace webSITE.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        private readonly UserManager<Mahasiswa> userManager;

        public LoginModel(SignInManager<Mahasiswa> signInManager, ILogger<LoginModel> logger, UserManager<Mahasiswa> userManager)
        {
